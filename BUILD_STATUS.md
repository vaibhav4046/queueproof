...
- Isolated QueueProof repository and dedicated `codex/queueproof-build` work.
- Dynamic HydraDB v2 catalogue/connector/query adapter.
- Encrypted HydraDB account onboarding.
- Connector discovery, resource selection, sync request, and canary verification APIs.
- D1 schema and 44-table migration.
- Retrieval planner, source trace, injection flagging, and audit storage.
- Deterministic ranking/comparison/counterfactual library.
- Authenticated workspace-scoped MCP server and fail-closed route.
- Responsive Circuit Shrine UI and original social asset.
