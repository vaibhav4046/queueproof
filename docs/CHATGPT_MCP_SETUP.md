...
answer, evidence-linked claims, contradictions, missing information, validation status, raw
sanitized evidence, provider coverage, latency, and HydraDB call count. Record it as the **public
